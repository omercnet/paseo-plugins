...
| [#2260](https://github.com/getpaseo/paseo/issues/2260), [PR #2261](https://github.com/getpaseo/paseo/pull/2261) | **Verified** | Incomplete or compacted `agent_end` frames use complete streamed `message_end` evidence or bounded post-idle history correlated by entry ID. Streamed and recovered success and failure outcomes are preserved; missing, unavailable, or non-correlatable evidence fails closed with content-free count diagnostics. |
